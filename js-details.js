...
$(document).ready(function(){
	alert("loading............");
	$("button.bookbtn").click(function(){
	
		var index = $( "button.bookbtn" ).index( this );
		//alert(index);
		
		var name = $('#roomtype'+index).html();
		alert(name);
		
		 var data=$("#rd").val();
		 if(data!=null){
			 data.split(",");
			 alert("after splitting..."+data[0]);
		 }
		 alert("data....."+data);
		 data=data+","+name;
		 alert(data);
	...
	/*var name = $('h4.opensans').html();*/
//	var name =$(this).find("h4.opensans").html();
	/* $( "h4.opensans" ).each(function( index, element ) {*/
	//alert("in request click"+name);
	 /*});*/
	// $("p").hide();
});
});
